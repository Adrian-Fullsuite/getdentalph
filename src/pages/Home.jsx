        ...
        <div className="mt-20 mb-16 md:w-2/4 md:text-left">
          <div className="mt-5 mb-5 md:mb-10 mx-5 md:ml-0">
            <h1 className="font-bold text-4xl md:text-6xl">
              Precision Care Radiant Smiles
            </h1>
          </div>
          <div className="text-[#787878] mx-2.5 mb-5 md:ml-0">
            <p className="md:w-3/4 md:text-lg">
              getDental brings you access to a network of top-notch dentists
              across multiple convenient locations. No matter where you are, our
              extensive network means that quality dental care is always within
              reach.
            </p>
          </div>
