  ...
  return (
    <>
      <footer className="flex flex-col items-center bg-[#1e4d9b] text-center dark:bg-neutral-600 lg:text-left">
        <div className="container p-6 text-white dark:text-neutral-200">
          <div className="grid gap-4 lg:grid-cols-3">
            <div className="mb-6 md:mb-0">
              <h5 className="mb-2 font-medium ">getdentalph.com</h5>
            ...
            <div className="mb-6 md:mb-0">
              ...
              <p className="mb-4">
                Lorem ipsum dolor sit amet consectetur. Nulla pretium aliquam eu
                nulla. Facilisi dignissim venenatis consequat hendrerit
                pellentesque tincidunt ac. Nunc nulla.
              </p>
              ...
              <div className="flex rounded-md shadow-sm">
                ...
                <button
                  type="button"
                  className="py-3 px-4 inline-flex flex-shrink-0 justify-center items-center gap-2 rounded-r-md border border-transparent font-semibold bg-[#5d93f0] text-white hover:bg-blue-600 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
                >
                  Register
                </button>
              </div>
